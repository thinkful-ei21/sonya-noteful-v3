...
// we need each of these hook functions to return a promise
  ...
  describe('GET /api/notes', function() {
    ...
    it('should return a list of the correct right fields', function() {
      return Promise.all([
        Note.find().sort({updatedAt: 'asc'}),
        chai.request(app).get('/api/notes')
      ])
        .then(([data, res]) => {
          expect(res).to.have.status(200);
  ...
  describe('GET /api/notes/:id', function() {
    ...
    //the string 'DOESNOTEXIST' is a 12 bytes which is a valid Mongo ObjectId
  ...
  describe('POST /api/notes', function() {
    ...
    it('should return an error if no title is given', function() {
      const newItem = {
